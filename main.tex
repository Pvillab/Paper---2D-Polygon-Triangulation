...
\section{Introduction}\justifying
...
\begin{figure}[H]
    \centering
    \includegraphics[width=150px,height=150px,keepaspectratio]{delaunay1.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=150px,height=150px,keepaspectratio]{delaunay25.jpg}
    \caption{Delaunay Triangulation, 7 data points}
    \label{fig:Delaunay2}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=200px,height=150px,keepaspectratio]{SpiderMan}
    \caption{Spider-Man Ear clipping results}
    \label{fig:Result1}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=200px,height=150px,keepaspectratio]{totoro}
    \caption{Totoro Ear Clipping results}
\end{figure}
For the second experiment as expected, the time for generating Delaunay triangles increases as the number of data points increases as well (shown in figures 10 and 11). Also, it we noticed that the number of triangles generated have the same behavior, as the amount of data points increases, there are more triangles generated too. Figure \ref{fig:delaunayResult1} shows the behavior of the algorithm using different amounts of starting data points.

\begin{figure}[H]
    \centering
    \includegraphics[width=200px,height=150px,keepaspectratio]{DelaunayGraph.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=200px,height=150px,keepaspectratio]{DelaunayGraph2.png}
